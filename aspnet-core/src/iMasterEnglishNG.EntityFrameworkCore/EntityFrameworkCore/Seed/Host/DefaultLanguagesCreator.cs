...
namespace iMasterEnglishNG.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

        private readonly iMasterEnglishNGDbContext _context;

        private static List<ApplicationLanguage> GetInitialLanguages()
        {
            var tenantId = iMasterEnglishNGConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(iMasterEnglishNGDbContext context)
        {
            _context = context;
        }
