...
{
    public abstract class iMasterEnglishNGWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static iMasterEnglishNGWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(iMasterEnglishNGWebMvcModule).Assembly.FullName);
        }
        ...
        protected void UsingDbContext(Action<iMasterEnglishNGDbContext> action)
        {
            using (var context = IocManager.Resolve<iMasterEnglishNGDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected T UsingDbContext<T>(Func<iMasterEnglishNGDbContext, T> func)
        {
            T result;
        ...
        protected async Task UsingDbContextAsync(Func<iMasterEnglishNGDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<iMasterEnglishNGDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<iMasterEnglishNGDbContext, Task<T>> func)
        {
            T result;
